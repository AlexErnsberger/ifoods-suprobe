  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4">
        <logo-model class="wow slideInUp"></logo-model>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-4" v-for="(news,index) in newsList" :key="index">
  ...
  data () {
    return {
      laterlyNews: {
        ...
        abstract: `超级探针很好的解决了食品信息知情权、安全保障的问题。
      ...
      newsList: [{
        ...
        本次食安链为大会提供的超级探针食品快检系统，具有便携、易操作等特点。使用时，通过与手机Dapp蓝牙连接的硬件超级探针对着食品轻轻一探，
      ...
      },
      {
        ...
        title: '中国国际肉类展||食安链专家携超级探针参与"最受关注肉类好食材"品评活动',
        ...
        参评产品以企业在产业周现场展示及推广的产品为主，食安链专家携超级探针参与"最受关注肉类好食材"品评活动。`
      }]
    }
  }
}
