...
<div id="news3">
  <div class="container">
    <article-model>
      ...
      <h4>研发超极探针、致力于解决食品安全问题的最后一公里</h4>
      ...
      <p>
        超极探针和移动端示意图（作为Ifoods chain的核心硬件，本身的体积很小，方便随身携带。）
        ...
        超极探针的研发就是基于这最后一公里。在卡隆看来，当超极探针能够准确便捷高效的检测出食品问题，那么每个人手里都有一个超极探针，就是理所应当的。因为食品安全涉及的是全家人的健康问题。
        ...
        据透露，超极探针的demo将在今年6月推出，预计在9月，超极探针将完成测试迭代正式上线。
      </p>
      <h4>总结</h4>
      <p>
