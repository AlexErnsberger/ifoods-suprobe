...
// },
  img: '/static/img/news/news7/news7.jpg',
  path: '',
  href: 'https://mp.weixin.qq.com/s/0RTQLIKsx7IvgSMzddn_sA',
  title: '超极探针将同北京食品科学研究院、中国肉类食品中和研究中心开展合作，打造食品领域便民技术',
  publishTime: '今天',
  abstract: `超级探针硬件开发结合了人工智能和区块链技术，可作为食品行业的底层基石去搭建数据生态。三方互相合作也将推进超极探针智能硬件的完善性，
  更广泛应用到行业中，从而降低行业内检测成本，简化流程，提高食品行业机构效率。超极探针更加期待合作能将检测技术应用到更多类别的食品检测中，让科技便民生活。
  北京市食品科学研究院表示：将与超极探针开展数据上链合作，联合开发更多食品快检数据模型，不断优化食品领域基础数据建设，保障老百姓食品消费知情权。
  中国肉类食品综合研究中心表示：食品检测技术也应当跟上时代的发展进步，研发出先进硬件让老百姓都能用、会用，才能将快检技术惠民生活。`
},
{
